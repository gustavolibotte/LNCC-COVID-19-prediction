...
if (rank == root):
    ...
    # log_geral_post = open("../logs/log"+datetime_now+"/Posterior1/log_geral_1_"+datetime_now+".txt", "w")
    # log_geral_post.write(datetime_now + "\n\n")
    # log_geral_post.write("Data Source: COVID-19 Dataset (on Kaggle)\n")
    # log_geral_post.write("https://www.kaggle.com/imdevskp/corona-virus-report\n\n")
    # log_geral_post.write("Rejection ABC fitting of epidemic curves\n")
    # log_geral_post.write("\nModels: "+", ".join(models))
    # log_geral_post.write("\nLocations: "+", ".join(locations))
    # log_geral_post.write("\n\n#####################################################################\n\n")
    # log_geral_post.write("Number of Iterations: %i\n" % (n))
    # log_geral_post.write("Posterior 1")
    # log_geral_post.write("\n\n############################   RESULTS   ############################\n\n")
