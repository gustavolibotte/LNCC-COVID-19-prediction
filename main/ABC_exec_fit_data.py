        ...
        for days_idx in range(start_idx, len(days_sets)):
            ...
            for k in range(model.nparams):
                ...
                if (model.params[k] == r"$N$"):
                    ...
                    model.prior_args[k] = (int(pop_state[locations[i]]/100), int(pop_state[locations[i]]/2))
                    model.prior_bounds[k] = (int(pop_state[locations[i]]/100), int(pop_state[locations[i]]/2))
